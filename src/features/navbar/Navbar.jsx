      ...
      <div className="min-h-full ">
                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      {items.length > 0 && (
                        <span className="inline-flex items-center mb-7 -ml-3 z-10 rounded-full bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                          {items.length}
                        </span>
                      )}
        ...
        <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <button className="text-3xl font-bold tracking-tight text-gray-900">
              E-Commerce
            </button>
          </div>
        </header>
