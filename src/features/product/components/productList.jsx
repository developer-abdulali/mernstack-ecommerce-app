...
const filters = [
  {
    ...
    options: [
      ...
      { value: "morotcycles", label: "morotcycles", checked: false },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Dermiv", label: "Dermiv", checked: false },
      ...
      { value: "Boho Decer", label: "Boho Decer", checked: false },
      { value: "Fly Wooden", label: "Fly Wooden", checked: true },
