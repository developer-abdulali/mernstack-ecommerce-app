...
//         <form
//           onSubmit={submitHandler}
//           className="bg-white shadow-md rounded px-5 pb-8 mb-4"
//         >
//           <div className="mb-4">
...
//               className="appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#436C68]"
//             >
//               <span className="absolute">Country / Region</span>
...
//                   <input
//                     type="radio"
//                     className="form-radio custom-accent cursor-pointer"
//                     name="paymentMethod"
//                     value={method}
//                     checked={paymentMethod === method}
//                     onChange={(e) => setPaymentMethod(e.target.value)}
//                   />
//                   <span className="ml-2 cursor-pointer">{method}</span>
//                 </label>
//               ))}
//             </div>
//             {paymentMethod === "NayaPay" && (
