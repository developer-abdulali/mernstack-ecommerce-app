...
const Products = () => {
  ...
  }, [filteredProductsQuery.data, dispatch, searchInput]);
  ...
  return (
    <div className="px-5">
      <div className="flex flex-col md:flex-row">
        {/* filters  */}
        <aside
          className={`border-r-8 border-[#EDEDED] w-[288px] p-4 bg-white sticky top-0 h-screen md:block br ${
            isFilterOpen
        ...
        >
            ...
            {uniqueBrands?.map((brand) => (
              <div key={brand} className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 custom-accent"
                />
                <label
                  htmlFor={brand}
                  className="ml-2 text-base cursor-pointer font-normal"
                >
                  {brand}
                </label>
              </div>
          ...
          <div>
            {categories?.map((c) => {
              return (
                <div key={c._id} className="flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    id={c._id}
                  ...
                  <label
                    htmlFor={c._id}
                    className="ml-2 text-base font-normal cursor-pointer"
                  >
                    {c.name}
                  </label>
                </div>
            ...
            <div className="flex flex-col">
              {[5, 4, 3, 2, 1].map((rating) => (
                <div key={rating} className="flex items-center">
                  ...
                  <label
                    htmlFor={`${rating}-star`}
                    className="flex items-center ml-2 cursor-pointer text-base font-normal"
                  >
                    <span>{rating}</span>
                    <FaStar className="text-[#436C68] ml-1 cursor-pointer" />
            ...
            <div className="flex flex-col">
              <div className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 cursor-pointer custom-accent"
                />
                <label
              ...
              <button
                className="md:hidden underline mt-2 w-full border cursor-pointer bg-gray-100"
                onClick={() => window.location.reload()}
              >
                Clear
              </button>
